...
class _ProfilProzorState extends State<ProfilProzor> {
  ...
  void uredi() {
    setState(() {
      usernameController.text = korisnik?['username'] ?? "N/A";
      emailController.text = korisnik?['email'] ?? "N/A";
      imePrezimeController.text = korisnik?['korisnikInfos'][0]['imePrezime'] ?? "N/A";
      telefonController.text = korisnik?['korisnikInfos'][0]['telefon'] ?? "N/A";
      gradController.text = adresaK?['grad'] ?? "N/A";
