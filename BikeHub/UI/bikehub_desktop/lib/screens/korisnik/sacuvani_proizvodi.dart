                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: _showBicikli ? Color.fromARGB(255, 87, 202, 255) : Color.fromARGB(255, 242, 242, 242),
                            ),
                            child: Text(
                              'Bicikli',
                              style: TextStyle(
                                color: _showBicikli ? Colors.white : Colors.blue,
                              ),
                            ),
                          ),
                        ),
                      ...
                      Expanded(
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: _showBicikli ? const Color.fromARGB(255, 242, 242, 242) : Color.fromARGB(255, 87, 202, 255),
                            ),
                            child: Text(
                              'Dijelovi',
                              style: TextStyle(
                                color: _showBicikli == false ? Colors.white : Colors.blue,
                              ),
                            ),
                          ),
                        ),
                    ...
                    child: FutureBuilder<Map<String, List<Map<String, dynamic>>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Container(
                          ...
                          alignment: Alignment.center,
                          child: _showBicikli ? _buildBicikliList(sacuvaniBicikli) : _buildDijeloviList(sacuvaniDijelovi),
                        );
                      },
                    ),
                  ),
