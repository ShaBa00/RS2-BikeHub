...
//
  ...
  Future<String> postPromocijaBicikl({
    ...
    final String baseUrl = '${HelperService.baseUrl}/PromocijaBicikli';
  ...
  Future<bool> isPromovisan({required int biciklId}) async {
    final Map<String, dynamic> queryParams = {
      'biciklId': biciklId.toString(),
    };

    // Ručno sastavljanje URL-a
    Uri uri = Uri.parse('${HelperService.baseUrl}/PromocijaBicikli');
