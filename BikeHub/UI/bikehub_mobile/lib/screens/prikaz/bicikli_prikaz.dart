      ...
      if (kategorije != null && kategorije.isNotEmpty) {
        setState(() {
          ...
          _odabranaKategorijaBicikl =
              _kategorijeBicikl?.firstWhere((kategorija) => kategorija['kategorijaId'] == kategorijaP, orElse: () => {'naziv': 'N/A'});
        });
      }
    } catch (e) {}
  }
  ...
  _initialize() async {
    try {
      ...
      setState(() {
        ...
        velicinaTocka = result['velicinaTocka'] != null && result['velicinaTocka'].toString().isNotEmpty ? result['velicinaTocka'].toString() : "N/A";

        brojBrzina =
            result['brojBrzina'] != null && result['brojBrzina'].toString().isNotEmpty ? int.tryParse(result['brojBrzina'].toString()) ?? 0 : 0;
        kolicinaBicikla =
